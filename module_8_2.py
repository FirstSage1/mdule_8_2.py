...
def calculate_average(numbers): # f принимает коллекцию numbers и возвращает:
    try:                    # среднее арифметическое всех чисел.
    # используем функцию personal_sum написанную ранее.
        summ_shisel = (len(numbers) - personal_sum(numbers)[1]) # кол-во чисел
        return personal_sum(numbers)[0] / summ_shisel
